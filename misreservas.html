...
<head>
    ...
    <link rel="stylesheet" href="/estilos/misReservas.css">
...
<body>
    ...
    <main>
        ...
        <ul>
            <li>
                <img src="/imagenes/portadaGenerica.png" alt="detalle imagen libro 1">
                <h2><a href="/libros/libro1/libro.html">Titulo del libro 1</a></h2>
                <p>Autor</p>
                <p>isbn</p>
                <p>Descripción</p>
                <p>$Precio</p>
                <p>Estado</p>
                <button>
                    <img src="/imagenes/iconoEliminar.svg" alt="Eliminar">
                </button>
            </li>
            <li>
                <img src="/imagenes/portadaGenerica.png" alt="detalle imagen libro 2">
                <h2><a href="/libros/libro2/libro.html">Titulo del libro 2</a></h2>
                <p>Autor</p>
                <p>isbn</p>
                <p>Descripción</p>
                <p>$Precio</p>
            ...
            <li>
                <img src="/imagenes/portadaGenerica.png" alt="detalle imagen libro 3">
                <h2><a href="/libros/libro3/libro.html">Titulo del libro 3</a></h2>
                <p>Autor</p>
                <p>isbn</p>
                <p>Descripción</p>
                <p>$Precio</p>
